...
app.add_url_rule('/authentication/forgot-password',
                 'forgot_password',
                 views.forgot_password,
                 methods=['GET', 'POST'])
app.add_url_rule('/authentication/reset-with-token/<token>',
                 'reset_with_token',
...
app.add_url_rule('/user/account-settings/<slug>',
                 'account_settings',
                 views.account_settings, methods=['GET', 'POST'])
...
app.add_url_rule('/api/employee/doctor/load-packages',
                 ...
                 methods=['POST'])
app.add_url_rule('/api/employee/doctor/load-medicine',
                 'load_medicine',
                 fetcher.load_medicines_list,
                 methods=['POST'])
app.add_url_rule('/api/authentication/check-signin-infor',
                 'check_signin_infor',
                 fetcher.check_signin_infor,
                 methods=['POST'])
app.add_url_rule('/api/authentication/check-signup-infor',
                 'check_signup_infor',
                 fetcher.check_signup_infor,
                 methods=['POST'])
app.add_url_rule('/api/authentication/check-profile-infor',
                 'check_profile_infor',
                 fetcher.check_profile_infor,
                 methods=['POST'])
app.add_url_rule('/api/authentication/check-account-exists',
                 'check_account_exists',
                 fetcher.check_account_exists,
                 methods=['POST'])
app.add_url_rule('/api/appointment/check-appointment-availability',
